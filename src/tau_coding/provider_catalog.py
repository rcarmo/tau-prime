...
BUILTIN_PROVIDER_CATALOG: tuple[ProviderCatalogEntry, ...] = (
    ...
    ProviderCatalogEntry(
        ...
        model_overrides={
            "claude-opus-5": ProviderModelOverride(
                thinking_modes={
                    "off": ThinkingMode(api_value="disabled"),
                    "low": ThinkingMode(api_value="adaptive"),
                    "medium": ThinkingMode(api_value="adaptive"),
                    "high": ThinkingMode(api_value="adaptive"),
                    "xhigh": ThinkingMode(api_value="adaptive", label="max"),
                },
                thinking_default="medium",
            ),
        },
    ...
    ProviderCatalogEntry(
        ...
        models=("kimi-k3", "kimi-for-coding", "kimi-k2-thinking"),
    ...
    ProviderCatalogEntry(
        ...
        model_overrides={
            ...
            "kimi-k3": ProviderModelOverride(always_thinking=True),
