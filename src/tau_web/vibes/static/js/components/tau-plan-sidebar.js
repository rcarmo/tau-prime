...
export function TauPlanSidebar({sessionId}){
 ...
 <div class="plan-sidebar-header"><div class="plan-sidebar-title">Plan</div><div class="plan-sidebar-subtitle">${sessionId||'No session'}${dirty?' • unsaved':''}</div></div>
 <div class="plan-sidebar-progress" aria-label="Plan checklist progress"><div class="plan-sidebar-progress-meta"><span class="plan-sidebar-progress-label">${progress.total?`${progress.done}/${progress.total} completed`:'No checklist items'}</span><span class="plan-sidebar-progress-percent">${progress.percent}%</span></div><div class="plan-sidebar-progress-track" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow=${progress.percent}><span class="plan-sidebar-progress-fill" style=${`width:${progress.percent}%`}></span></div></div>
