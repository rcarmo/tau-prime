export function Dashboard() {
  return (
    <section id="session-dashboard" className="session-dashboard" aria-labelledby="dashboard-title" data-open="false" hidden>
      <div className="dashboard-shell">
        <header className="dashboard-header">
          ...
          <button id="dashboard-close" className="icon-button" type="button">Close</button>
        </header>
